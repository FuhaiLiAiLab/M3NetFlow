...
def build_geomixhop_model(args, device, dataset):
...
def train_geomixhop(args, fold_n, load_path, iteration_num, device, dataset):
    ...
    model = build_geomixhop_model(args, device, dataset)
    if args.model == 'load':
    ...
    for i in range(1, epoch_num + 1):
        ...
        # fold_n = 1
        test_save_path = path
        test_pearson, test_loss, tmp_test_input_df = test_geomixhop(prog_args, fold_n, model, test_save_path, device, dataset)
...
def test_geomixhop(args, fold_n, model, test_save_path, device, dataset):
    print('-------------------------- TEST START --------------------------')
    print('-------------------------- TEST START --------------------------')
    print('-------------------------- TEST START --------------------------')
    print('-------------------------- TEST START --------------------------')
...
if __name__ == "__main__":
    ...
    start_iter_num = 101 * epoch_iteration
    train_geomixhop(prog_args, fold_n, load_path, start_iter_num, device, dataset)

    # ### TEST THE MODEL
    # # TEST [FOLD-1]
    # fold_n = 1
    # model = build_geomixhop_model(prog_args, device, dataset)
    ...
    # test_geomixhop(prog_args, fold_n, model, test_save_path, device, dataset)